...
tarurl = "https://192.168.3.56:3443/"
apikey = "1986ad8c0a5b3df4d7028d5f3c06e936ce3cf93e80a70434691e18edb1fd7c86f"
...
def delete_target(target_id):
    # 删除scan_id的扫描
    try:
        response = requests.delete(tarurl + "/api/v1/targets/" + str(target_id), headers=headers, timeout=30,
                                   verify=False)
    except Exception as e:
        print(str(e))
        return
...
def getscan():
    ...
    try:
        ...
        for result in results['scans']:
            ...
            print(result['scan_id'], result['target']['address'], getstatus(result['scan_id']))
